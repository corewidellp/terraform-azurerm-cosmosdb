...
locals {
  ...
  firewall_ips         = var.firewall_ip == [] ? toset(compact(concat(var.azure_portal_access, var.azure_dc_access))) : toset(compact(concat(var.firewall_ip, var.azure_portal_access, var.azure_dc_access)))
